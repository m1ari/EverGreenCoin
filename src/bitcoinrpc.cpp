...
int ReadHTTPHeader(std::basic_istream<char>& stream, std::map<string, string>& mapHeadersRet)
{
    int nLen = 0;
    while (true)
    {
...
int ReadHTTP(std::basic_istream<char>& stream, std::map<string, string>& mapHeadersRet, string& strMessageRet)
{
    mapHeadersRet.clear();
    strMessageRet = "";
